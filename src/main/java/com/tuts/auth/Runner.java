...
//         authService.register(new UserRequest("FAITH KEBUT", "manager", "manager123", new ArrayList<>()));
//         authService.register(new UserRequest("MAXWEL BARNO", "admin", "admin123", new ArrayList<>()));
//         authService.register(new UserRequest("JOHN DOE", "user", "user123", new ArrayList<>()));
